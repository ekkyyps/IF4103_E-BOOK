<div class="container">
		...
		<div class="bagian2 form-login" style="width: 30%; float: right; padding-bottom: 30vw">
			<form action="<?php echo base_url('index.php/Admin/login'); ?>" action="GET"  method="post" style="background-color:white;">       
                <h3 class="text-center title-login" style=" font-weight: bold; ">LOGIN ADMIN</h3>
                    ...
                    <input type="submit" class="btn btn-primary" value="LOG IN"  style="background-color: #3EBFB7; color: black;width: 150px; border-radius: 5px;">
            </form>
		</div>
	</div>